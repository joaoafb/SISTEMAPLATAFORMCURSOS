...
function checkaccount() {
    ...
    db.collection("usuarios").doc(localStorage.getItem("email")).get().then((doc) => {
        if (doc.exists) {
            ...
            document.getElementById("totalcursos").innerHTML = doc.data().TotalCursos
            document.getElementById("quantidadeshared").innerHTML = doc.data().Shared + " Pessoas Usaram Seu Código" + ' </span>'
            document.getElementById("meucodigo").innerText = 'Seu Código: ' + doc.data().Codigo
